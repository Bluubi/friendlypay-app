...
import {ControlGroup, getControlInput} from "../../../../shared/Form/Control-Group.tsx";
...
export const NewPaymentPage = () => {
    ...
    const newPayment = (event: REACT.FormEvent) => {
        ...
        const newPaymentRepository = container.resolve<NewPaymentRepository>("NewPaymentRepository");
